...
import { IntegrityProvenanceEngine } from '../integrity/IntegrityProvenanceEngine';
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 p-4 sm:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Integrated Layer 2 Cryptographic Integrity & BSA Section 57 Engine */}
        <div className="pt-4">
          <IntegrityProvenanceEngine />
        </div>

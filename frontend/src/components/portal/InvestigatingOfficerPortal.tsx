...
import { EvidenceIngestionHub } from '../ingestion/EvidenceIngestionHub';
import { AIInvestigationWorkspace } from '../ai/AIInvestigationWorkspace';
import { EvidenceGraphWidget } from '../graph/EvidenceGraphWidget';
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 p-4 sm:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Integrated Layer 1 Evidence Ingestion & Adapters Hub */}
        <div className="pt-4 space-y-6">
          <EvidenceIngestionHub />
